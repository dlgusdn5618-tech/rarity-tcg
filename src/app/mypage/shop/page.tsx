...
type Listing = {
  ...
  price: number;
  series: string;
  hasPhotoCert: boolean;
  hasSafeTrade: boolean;
  gradingInfo?: string;
};
...
type SoldItem = { nameKo: string; rarity: string; price: number; ago: string; review: string };
        ...
        <div className="px-4 pt-4 pb-10 flex flex-col gap-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-2 px-0.5">
              ...
              <span className="text-[11px] text-gray-400" style={{ fontWeight: 500 }}>{LISTINGS.length}장</span>
            </div>
